...
import flyco.tablayout.utils.UnreadMsgUtils;
...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTextSelSize = ta.getDimension(R.styleable.SlidingTabLayout_tl_textSelsize, sp2px(15));
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            tabView = View.inflate(mContext, R.layout.szrm_layout_tab, null);
    ...
    public void addNewTab(String title) {
        View tabView = View.inflate(mContext, R.layout.szrm_layout_tab, null);
        if (mTitles != null) {
            mTitles.add(title);
        }
...
//                    new LinearLayout.LayoutParams(dp2px(130), LayoutParams.MATCH_PARENT);
            ...
            lp_tab = mTabSpaceEqual ?
                    new LinearLayout.LayoutParams(0, LayoutParams.MATCH_PARENT, 1.0f) :
                    new LinearLayout.LayoutParams(dp2px(75), LayoutParams.MATCH_PARENT);
        } else if (2 == position) {
            lp_tab = mTabSpaceEqual ?
                    new LinearLayout.LayoutParams(0, LayoutParams.MATCH_PARENT, 1.0f) :
                    new LinearLayout.LayoutParams(dp2px(45), LayoutParams.MATCH_PARENT);
        }
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
            ...
            if (tv_tab_title != null) {
                ...
                tv_tab_title.setTextSize(TypedValue.COMPLEX_UNIT_PX, i == mCurrentTab ? mTextSelSize : mTextsize);
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            if (tab_title != null) {
                ...
                tab_title.setTextSize(TypedValue.COMPLEX_UNIT_PX, i == position ? mTextSelSize : mTextsize);
            }
        }
    }
    ...
    public void showMsg(int position, String str) {
        ...
        MsgView tipView = (MsgView) tabView.findViewById(R.id.rtv_msg_tip);
        if (tipView != null) {
            UnreadMsgUtils.show(tipView, str);
