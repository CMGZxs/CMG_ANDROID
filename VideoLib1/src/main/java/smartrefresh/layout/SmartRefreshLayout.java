...
import static smartrefresh.layout.util.SmartUtil.dp2px;
import static smartrefresh.layout.util.SmartUtil.fling;
import static smartrefresh.layout.util.SmartUtil.isContentView;
...
import smartrefresh.layout.api.RefreshComponent;
import smartrefresh.layout.api.RefreshContent;
import smartrefresh.layout.api.RefreshFooter;
import smartrefresh.layout.api.RefreshHeader;
import smartrefresh.layout.api.RefreshKernel;
import smartrefresh.layout.api.RefreshLayout;
import smartrefresh.layout.constant.DimensionStatus;
import smartrefresh.layout.constant.RefreshState;
import smartrefresh.layout.constant.SpinnerStyle;
import smartrefresh.layout.listener.DefaultRefreshFooterCreator;
import smartrefresh.layout.listener.DefaultRefreshHeaderCreator;
import smartrefresh.layout.listener.DefaultRefreshInitializer;
import smartrefresh.layout.listener.OnLoadMoreListener;
import smartrefresh.layout.listener.OnMultiListener;
import smartrefresh.layout.listener.OnRefreshListener;
import smartrefresh.layout.listener.OnRefreshLoadMoreListener;
import smartrefresh.layout.listener.OnStateChangedListener;
import smartrefresh.layout.listener.ScrollBoundaryDecider;
import smartrefresh.layout.util.SmartUtil;
import smartrefresh.layout.wrapper.RefreshContentWrapper;
import smartrefresh.layout.wrapper.RefreshFooterWrapper;
import smartrefresh.layout.wrapper.RefreshHeaderWrapper;
import smartrefresh.simple.SimpleBoundaryDecider;
