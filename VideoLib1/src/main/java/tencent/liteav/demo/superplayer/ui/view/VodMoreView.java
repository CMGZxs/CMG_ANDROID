 ...
 *
 * 3、镜像、硬件加速开关回调{@link #onCheckedChanged(CompoundButton, boolean)}
 */

public class VodMoreView extends RelativeLayout implements CompoundButton.OnCheckedChangeListener {
